<?php
class TrustindexPlugin_aliexpress
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for AliExpress Reviews", "do-not-care-AliExpress");
...
if (in_array($styleId, [8, 10, 11, 12, 13, 20, 22, 24, 25, 26, 27, 28, 29, 35, 55, 56, 57, 58, 59, 60, 61, 62, 106])) {
...
$content = str_replace('%footer_link%', $this->getPageUrl(), $content);
} else {
