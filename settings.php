...
$pluginManager = 'TrustindexPlugin_aliexpress';
$pluginManagerInstance = $trustindex_pm_aliexpress;
$pluginNameForEmails = 'AliExpress';
$newBadgeTabs = [];
...
$logoCampaignId = 'wp-aliexpress-l';
...
$assetCheckCssId = 'trustindex_settings_style_aliexpress';
