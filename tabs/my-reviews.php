...
$text = "";
$link = "https://cdn.trustindex.io/assets/platform/".ucfirst("aliexpress")."/star/";
if (!is_numeric($score)) {
return $text;
}
...
<?php echo $pluginManagerInstance->getProFeatureButton('wp-aliexpress-pro'); ?>
</div>
...
<td class="ti-text-center source-<?php echo ucfirst("aliexpress") ?>"><?php echo trustindex_plugin_write_rating_stars($review->rating); ?></td>
...
<?php endif; ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-reply'); ?>" class="ti-btn ti-btn-sm btn-post-reply"><?php echo sprintf(__('Upload reply to %s', 'trustindex-plugin'), 'AliExpress'); ?></a>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-aliexpress-4';
$tiCampaign2 = 'wp-aliexpress-5';
