...
$stepList = [
sprintf(__('Connect %s', 'trustindex-plugin'), 'AliExpress'),
...
<h1 class="ti-header-title"><?php echo sprintf(__('Connect %s', 'trustindex-plugin'), 'AliExpress'); ?></h1>
...
<?php else: ?>
<div class="ti-box">
<form method="post" action="" data-platform="aliexpress" id="ti-connect-platform-form">
...
$labelText = sprintf(__('%s Business URL', 'trustindex-plugin'), 'AliExpress');
$infoText = __("Type your business/company's URL and select from the list", 'trustindex-plugin');
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), "AliExpress");
$placeholder = __('e.g.:', 'trustindex-plugin') . ' ' . esc_attr($exampleUrl);

$labelText = __('AliExpress Seller Profile URL', 'trustindex-plugin');
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), __('AliExpress Seller Profile', 'trustindex-plugin'));
...
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php echo sprintf(__('Check some %s widget layouts and styles', 'trustindex-plugin'), 'AliExpress reviews'); ?></h1>
...
<p>
<?php echo sprintf(__('There are no reviews on your %s platform.', 'trustindex-plugin'), 'AliExpress'); ?>
</p>
</div>
<?php endif; ?>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-aliexpress-1';
$tiCampaign2 = 'wp-aliexpress-2';
