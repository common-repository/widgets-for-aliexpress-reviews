...
$pluginSlug = "widgets-for-aliexpress-reviews/widgets-for-aliexpress-reviews.php";
...
$pluginUpdated = ($pluginManagerInstance->get_plugin_current_version() <= "12.4.1");
...
<?php else: ?>
<p><?php echo sprintf(__('You can connect your %s with your Trustindex account, and can display your widgets easier.', 'trustindex-plugin'), 'Widgets for AliExpress Reviews'); ?></p>
...
<a class="ti-btn ti-btn-default" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-aliexpress-4" target="_blank"><?php echo __('Create a new Trustindex account', 'trustindex-plugin');?></a>
</p>
</form>
<?php endif; ?>
<?php if ($trustindexSubscriptionId): ?>
